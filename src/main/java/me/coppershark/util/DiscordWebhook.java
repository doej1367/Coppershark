 ...
 * https://stackoverflow.com/a/71110576/6307611
 */
public class DiscordWebhook {
	 ...
	 * @param token
	 */
	public DiscordWebhook(String channel_id, byte[] token) {
		this.url = "https://discord.com/api/webhooks/" + channel_id + "/" + new String(token);
	}
